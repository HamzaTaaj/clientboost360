  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center bg-[var(--background)] pt-32 pb-20 px-4 sm:px-6">
      <div className="w-full max-w-screen-xl mx-auto">
        {/* Top Text */}
        <div className="w-full text-white npy-4 px-2 lg:px-0 text-center lg:text-left pt-20">
          <motion.h1
          ...
          >
            ...
            <motion.div
              variants={itemVariants}
              className="flex justify-center lg:justify-start items-center gap-4 mt-2 mb-4 flex-wrap"
            >
              <div className="hidden lg:flex items-center gap-x-2">
                <span className="bg-white text-gray-500 text-sm font-medium px-4 py-1 rounded-full">
                  Meta Ads
                </span>
                <span className="bg-white text-gray-500 text-sm font-medium px-4 py-1 rounded-full">
                  CRM
                </span>
                <span className="bg-[var(--turq)] text-white text-sm font-medium px-4 py-1 rounded-full">
                  Growth
                </span>
              </div>
            ...
            <motion.div
              variants={itemVariants}
              className="flex lg:hidden justify-center items-center gap-x-2 mt-4 flex-wrap"
            >
              <span className="bg-white text-gray-500 text-sm font-medium px-4 py-1 rounded-full">
                Meta Ads
              </span>
        ...
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-8">
          ...
          >
            ...
            >
              ClientBoost360 is a digital marketing brand owned and operated by
              Synergy Stream LLC, a Virginia-based technology and marketing
              company. A full-stack digital marketing partner for law firms,
              clinics, and professional service providers ready to grow, without
